...
public final class QueryUtils {
     ...
     */
    public static ArrayList<eartquakes> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<eartquakes> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for(int i = 0; i < features.length(); ++i){
                ...
                JSONObject a = c.getJSONObject("properties");

                Double pMagRaw = a.getDouble("mag");
                String pLoc = a.getString("place");
                long pTime = a.getLong("time");
                String URL = a.getString("url");

                DecimalFormat formatter = new DecimalFormat("0.0");
                String pMagFormatted = formatter.format(pMagRaw);
                Double pMag = Double.parseDouble(pMagFormatted);


                Date dateObject = new Date(pTime);
                ...
                earthquakes.add(new eartquakes(pMag, pLoc, dateToDisplay, timeToDisplay, URL));
            }
